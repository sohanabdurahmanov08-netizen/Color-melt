...
namespace ColorMelt.Core
{
    ...
    public class BlockNode : MonoBehaviour, IFlowNode
    {
        ...
        [Tooltip("Sound played when the block is destroyed.")]
        [SerializeField] private AudioClip destructionSound;

        [Tooltip("Volume of the destruction sound.")]
        [SerializeField, Range(0f, 1f)] private float destructionSoundVolume = 1f;
        ...
        /// <summary>
        /// Вызывается один раз, в момент разрушения — на него подписывается LevelFlowManager.
        /// </summary>
        ...
        /// <summary>
        /// Configures a block that was created by the level generator.
        /// </summary>
        public void Configure(
            ColorType required,
            ChannelVisual channelBeforeBlock,
            float normalizedBlockStart,
            GameObject visualToHide,
            IFlowNode nextNode = null)
        {
        ...
        /// <summary>
        /// Lets a designer choose a different display colour if needed.
        /// </summary>
        ...
        private void ApplyVisualColor()
        {
            ...
            var color = ChannelVisual.ToUnityColor(
                useRequiredColorForVisual ? requiredColor : visualColor
            );
        ...
        private System.Collections.IEnumerator DestroyAfterDelay()
        {
            ...
            // Убираем только визуальный объект блока.
            if (blockVisual != null)
        ...
        {
            // A wrong colour remains a hard stop.
            if (!IsDestroyed)
                yield break;
